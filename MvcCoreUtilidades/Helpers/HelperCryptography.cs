...
namespace MvcCoreUtilidades.Helpers
{
    public class HelperCryptography
    {
        ...
        public static string CifrarContenido(string contenido, bool comparar)
        {
            if(comparar == false)
            {
                // NO QUEREMOS COMPARAR, SOLO CIFRAR, CREAMOS UN NUEVO SALT
                Salt = GenerateSalt();
            }
        ...
        {
            // EL CIFRADO SE REALIZA A NIVEL DE BYTES DEBEMOS CONVERTIR EL TEXTO DE ENTRADA A BYTES
            byte[] entrada;
            ...
            /* LOS OBJETOS DE CIFRADO TIENEN UN METODO LLAMADO ComputedHash() QUE RECIBEN UN ARRAY DE BYTES 
             * REALIZAN ACCIONES INTERNAS Y DEVUELVEN UN ARRAY DE BYTES[] CIFRADO */
